...
public class CropConfig {
    ...
    CommandLineRunner cropConfiguration(CropRepository repository) {
        return args -> {
            ...
            Crop europeanRadish = new Crop(CropStage.BUY, "European Radish", 150, 75, CropType.NOTREUSABLE, 1,
                    "european-radish");
            ...
            Crop purplePotato = new Crop(CropStage.BUY, "Purple Potato", 150, 65, CropType.NOTREUSABLE, 1,
                    "purple-potato");
            Crop redOnion = new Crop(CropStage.BUY, "Red Onion", 175, 100, CropType.NOTREUSABLE, 1, "red-onion");
            Crop redPotato = new Crop(CropStage.BUY, "Red Potato", 200, 125, CropType.NOTREUSABLE, 1, "red-potato");
            Crop scallion = new Crop(CropStage.BUY, "Scallion", 100, 25, CropType.NOTREUSABLE, 1, "scallion");
